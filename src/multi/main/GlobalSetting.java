...
public class GlobalSetting {
	...
	public static String TARGET_FLOW_NUM_OVERHEAD_RESULT_FILE_NAME = "data\\multi_targetFlowNum_vs_Overhead.txt";
	public static String MEMORY_REPLACEMENT_RESULT_FILE_NAME = "data\\samplehold_replacement_diffMemory.txt";
	...
	public static int NUM_PKTS_TO_SIGNAL_THE_NETWORK = 100000;
	
	public static double VOLUME_DROP_RATE = 0.02;
	
	public static int INTERVAL_SECONDS = 5; // the number of seconds in one interval
	public static int SIMULATE_INVERVALS = 12; // how many intervals to test
